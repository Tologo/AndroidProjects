                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(MainActivity.this, "Autenticación correcta"+user.getUid(),
                                    Toast.LENGTH_SHORT).show();

                            if (user != null) {
                                Intent llamada = new Intent(MainActivity.this, Principal.class);
                            ...
                            Toast.makeText(MainActivity.this, "Error en la Autenticación"+task.getException(),
                                    Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            // Sign in success, update UI with the signed-in user's information
                            FirebaseUser user = mAuth.getCurrentUser();
                            Toast.makeText(MainActivity.this, "Login correcto"+user.getUid(),
                                    Toast.LENGTH_SHORT).show();
                            ...
                            // If sign in fails, display a message to the user.
                            Toast.makeText(MainActivity.this, "Error en el login"+task.getException(),
                                    Toast.LENGTH_SHORT).show();
                        }
                    }
                });
